import ConjecturesMTupleTripleCount.Foundations.ChiBridge
import ConjecturesMTupleTripleCount.Foundations.Fourier
...
(`ConjecturesMTupleTripleCount/Foundations/Fourier.lean`) does the real work; the Walsh version
