...
-- NOTE: the `KasamiAPN.kasamiExp` compatibility alias that previously lived here
-- has been removed: it duplicated the real definition in
-- `ConjecturesMTupleTripleCount.Kasami.Classical.KasamiAPN`, causing an "environment already
-- contains 'KasamiAPN.kasamiExp'" clash when both modules were imported together.
