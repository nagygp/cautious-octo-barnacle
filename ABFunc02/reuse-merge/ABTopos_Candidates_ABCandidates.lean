...
def goldABDatum : ABFunc TypeTopos :=
  mkABFunc (Multiplicative (ZMod 4)) (fun x => x ^ 3) (one_pow _)
...
def kasamiABDatum : ABFunc TypeTopos :=
  mkABFunc (Multiplicative (ZMod 8)) (fun x => x ^ 13) (one_pow _)
...
def welchABDatum (t : ℕ) : ABFunc TypeTopos :=
  mkABFunc (Multiplicative (ZMod 8)) (fun x => x ^ (2^t + 3)) (one_pow _)
...
def nihoABDatum (t : ℕ) : ABFunc TypeTopos :=
  mkABFunc (Multiplicative (ZMod 16)) (fun x => x ^ (2^t + 2^(t/2) - 1)) (one_pow _)
...
def cckABDatum : ABFunc TypeTopos :=
  mkABFunc (Multiplicative (ZMod 32)) (fun x => x ^ 5 * x ^ 3) (by simp [one_pow])
...
def coulterMatthewsParentDatum : ABFunc TypeTopos :=
  mkABFunc (Multiplicative (ZMod 9)) (fun x => x ^ 5) (one_pow _)
...
def dingHellesethParentDatum : ABFunc TypeTopos :=
  mkABFunc (Multiplicative (ZMod 25)) (fun x => x ^ 13) (one_pow _)
...
def pn7ParentDatum : ABFunc TypeTopos :=
  mkABFunc (Multiplicative (ZMod 49)) (fun x => x ^ 25) (one_pow _)
...
def pn11ParentDatum : ABFunc TypeTopos :=
  mkABFunc (Multiplicative (ZMod 121)) (fun x => x ^ 61) (one_pow _)
...
def pn13ParentDatum : ABFunc TypeTopos :=
  mkABFunc (Multiplicative (ZMod 169)) (fun x => x ^ 85) (one_pow _)
