...
theorem kasami_bridge
  ...
  exact ⟨
    AB_implies_APN W δ q n hq hn hcard hAB H_parseval H_triv_a0 H_triv_ane0
      H_fourth_moment H_row_sum H_triv_row0 H_triv_rowne H_even,
    fun b hb => delta_card_fixed W q n hq hn hcard hAB H_parseval b hb,
    fun b hb => delta_pair_count W q n hq hn hcard hAB H_parseval b hb⟩
