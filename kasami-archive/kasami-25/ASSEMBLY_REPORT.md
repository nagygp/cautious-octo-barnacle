...
| 2b | `Qa_is_quadratic` | ❌ **Sorry** | — | Not yet formalized for Kasami specifically |
| 2c | `Ba_explicit` | ✅ **Partial** | `QuadFormGF2/Defs.lean` | `QuadFormF2.polar` (general definition) |
| 2d | `kasami_power_expansion` | ✅ **Partial** | `Kasami/CCDHelpers.lean` | `char2_sum_powers`, `gold_deriv` |
| 2e | `Ba_simplified` | ❌ **Sorry** | — | Not yet formalized |
