...
## ════════════════════════════════════════════
## CONJECTURES RENFORÇANTES (NEW)
## ════════════════════════════════════════════

See `CIC_Conjectures.md` for full CIC Unicode formulations.
Lean 4 proofs in `ABTopos/Spectral/MomentConjectures.lean`.

| Result | Statement | Status | Axioms |
|--------|-----------|--------|--------|
| **C₁** | M_m = s₊·c^m + s₋·(−c)^m (m≥1) | ✅ Prouvé | propext, choice, Quot.sound |
| **C₂** | M_{2k} = (s₊+s₋)·c^{2k} (k≥1) | ✅ Prouvé | propext, choice, Quot.sound |
| **C₃** | M_{2k+1} = (s₊−s₋)·c^{2k+1} | ✅ Prouvé | propext, choice, Quot.sound |
| **C₄** | M₂ = (s₊+s₋)·c² (Parseval) | ✅ Prouvé | propext, choice, Quot.sound |
| **C₅** | M_{m+2} = c²·M_m (m≥1) | ✅ Prouvé | propext, choice, Quot.sound |
| **C₆** | support = s₊ + s₋ | ✅ Prouvé | propext, choice, Quot.sound |
| **C₇** | M_m = |G|^{m−1}·κ_m | ✅ Prouvé | propext, choice, Quot.sound |
| **C₈** | κ_{m+2} = (c²/|G|²)·κ_m | ✅ Prouvé | propext, choice, Quot.sound |
| **C₁₀** | cube_sum = C₁[m=3] | ✅ Prouvé | propext, choice, Quot.sound |
| **C₁₁** | 3-val → bent → div=1 → discrete | ✅ Prouvé | propext, choice, Quot.sound |
